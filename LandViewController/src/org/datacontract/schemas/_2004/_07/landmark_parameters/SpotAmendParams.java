...
/**
 * <p>Java class for SpotAmendParams complex type.
 *
 * <p>The following schema fragment specifies the expected content contained within this class.
 *
 * <pre>
 * &lt;complexType name="SpotAmendParams">
 *   &lt;complexContent>
 ...
 *         &lt;element name="EnteredPrice" type="{http://www.w3.org/2001/XMLSchema}boolean" minOccurs="0"/>
 ...
 *         &lt;element name="SAPNumber" type="{http://www.w3.org/2001/XMLSchema}double" minOccurs="0"/>
...
@XmlType(name = "SpotAmendParams", propOrder = {
         ...
         "campaignNumber", "checkClash", "checkRepetition", "checkRestrictions", "clientPicked", "currencyCode",
         "daypartNo", "dealType", "deleteChargeTakeUp", "discountDate", "discounts", "enhanced", "enteredPrice",
         "functionalityType", "interactivityTypeNumber", "isEnteredPrice", "isMakeGoodRequired", "isMakePrimary",
         "isProgrammeLocked", "lineNumber", "lockSessionID", "makeGood", "makeGoodTakeUp", "mobilityRuleCode",
         "multiParts", "nonPreemptible", "optionExpiryDate", "organisationCode", "overrides", "positionCode",
         "postDiscountPrice", "preemptionStatus", "preemptorStatus", "processType", "promoSpotLink", "reasonCode",
         "regionalExclusions", "resetPrice", "rowId", "sapNumber", "scheduleNumber", "spotBitFlags", "spotLength",
         "spotNumber", "spotSalesAreaNumber", "spotStatus", "spotTypeCode", "swapSpotNumber", "useReserve"
    })
public class SpotAmendParams {
    ...
    @XmlElement(name = "EnteredPrice")
    protected Boolean enteredPrice;
    ...
    @XmlElementRef(name = "SAPNumber", namespace = "http://schemas.datacontract.org/2004/07/Landmark.Parameters.Spots",
                   type = JAXBElement.class, required = false)
    protected JAXBElement<Double> sapNumber;
    ...
    /**
     * Gets the value of the enteredPrice property.
     *
     * @return
     *     possible object is
     *     {@link Boolean }
    ...
    /**
     * Sets the value of the enteredPrice property.
     *
     * @param value
     *     allowed object is
     *     {@link Boolean }
     *
     */
    public void setEnteredPrice(Boolean value) {
        this.enteredPrice = value;
    }
    ...
    /**
     * Gets the value of the sapNumber property.
     *
     * @return
     *     possible object is
     ...
     *
     */
    public JAXBElement<Double> getSAPNumber() {
        return sapNumber;
    }

    /**
     * Sets the value of the sapNumber property.
     *
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link Double }{@code >}
     *
     */
    public void setSAPNumber(JAXBElement<Double> value) {
