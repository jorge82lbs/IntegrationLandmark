...
/** Esta clase Ejecuta en segundo plano el proceso de Lectura de Campañas<br/><br/>
 *
 * @author Jorge Luis Bautista - Omw
 *
 * @version 01.00.01
 *
 * @date Noviembre 6, 2019, 12:00 pm
 */
public class CampaignsCron implements Job{
    public CampaignsCron() {
        super();
    }
    ...
    public void execute(JobExecutionContext toJobExecutionContext) throws JobExecutionException {        
        ...
        loInput.setLsMessage("Ejecucion de Campaigns");
        ...
        System.out.println("ID["+liIdRequest+"]Finish de Cron(Campaigns) >> "+
