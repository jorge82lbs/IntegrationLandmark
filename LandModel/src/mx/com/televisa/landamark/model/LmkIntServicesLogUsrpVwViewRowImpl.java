...
// ---------------------------------------------------------------------
public class LmkIntServicesLogUsrpVwViewRowImpl extends ViewRowImpl {
    public static final int ENTITY_LMKINTSERVICESLOGUSRPVW = 0;
    ...
    public static final int INDCALCULATESTATUS = AttributesEnum.IndCalculateStatus.index();
     ...
     */
    public LmkIntServicesLogUsrpVwViewRowImpl() {
    }

    /**
     * Gets LmkIntServicesLogUsrpVw entity object.
     * @return the LmkIntServicesLogUsrpVw
     */
    public EntityImpl getLmkIntServicesLogUsrpVw() {
        return (EntityImpl) getEntity(ENTITY_LMKINTSERVICESLOGUSRPVW);
    }
    ...
    /**
     * Gets the attribute value for IND_CALCULATE_STATUS using the alias name IndCalculateStatus.
     * @return the IND_CALCULATE_STATUS
     */
    public String getIndCalculateStatus() {
        return (String) getAttributeInternal(INDCALCULATESTATUS);
    }

    /**
     * Sets <code>value</code> as attribute value for IND_CALCULATE_STATUS using the alias name IndCalculateStatus.
     * @param value value to set the IND_CALCULATE_STATUS
     */
    public void setIndCalculateStatus(String value) {
        setAttributeInternal(INDCALCULATESTATUS, value);
    }
