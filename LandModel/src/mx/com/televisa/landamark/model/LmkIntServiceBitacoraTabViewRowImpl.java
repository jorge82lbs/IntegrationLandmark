...
// ---------------------------------------------------------------------
public class LmkIntServiceBitacoraTabViewRowImpl extends ViewRowImpl {
    public static final int ENTITY_LMKINTSERVICEBITACORATAB = 0;
     ...
     */
    public LmkIntServiceBitacoraTabViewRowImpl() {
    }

    /**
     * Gets LmkIntServiceBitacoraTab entity object.
     * @return the LmkIntServiceBitacoraTab
     */
    public EntityImpl getLmkIntServiceBitacoraTab() {
        return (EntityImpl) getEntity(ENTITY_LMKINTSERVICEBITACORATAB);
    }
