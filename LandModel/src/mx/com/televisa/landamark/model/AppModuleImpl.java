...
public class AppModuleImpl extends ApplicationModuleImpl {
    ...
    public void insertServiceBitacoraModel(LmkIntServiceBitacoraRowBean toBean) {   
        ...
        LmkIntServiceBitacoraTabViewImpl    loObj = 
            getLmkIntServiceBitacoraTabView1();
        
        LmkIntServiceBitacoraTabViewRowImpl loNewRow = 
            (LmkIntServiceBitacoraTabViewRowImpl)loObj.createRow();        
        try {
            Integer lsIdUser = 
                Integer.parseInt(getValueSessionFromAttribute("loggedPgmIntegrationIdUser"));
            String lsUserName = 
                getValueSessionFromAttribute("loggedPgmIntegrationUser");
            loNewRow.setIdBitacora(getIdBitacora());
            loNewRow.setIdLogServices(toBean.getLiIdLogServices());
            loNewRow.setIdService(toBean.getLiIdService());
            loNewRow.setIndProcess(toBean.getLiIndProcess());
            loNewRow.setNumProcessId(toBean.getLiNumProcessId());
            loNewRow.setNumPgmProcessId(toBean.getLiNumPgmProcessId());
            loNewRow.setIndEvento(toBean.getLsIndEvento());
    ...
    /**
     * Obtiene una lista de parametros configurados por servicio
     * @autor Jorge Luis Bautista Santiago  
     * @param tiIdService
     * @return List
     */    
    
    public List<LmkIntServicesParamsRowBean> getParametersServiceByIdService(Integer tiIdService){
        ...
        try {
            ...
            if (laRows.length > 0) {
                for(Row loRow : laRows){
                    LmkIntServicesParamsTabViewRowImpl loRowTbl = 
                        (LmkIntServicesParamsTabViewRowImpl)loRow;   
                    LmkIntServicesParamsRowBean loParam = new LmkIntServicesParamsRowBean();
                    loParam.setLiIdParameterServ(loRowTbl.getIdParameterServ());
                    loParam.setLiIdService(loRowTbl.getIdService());
                    loParam.setLsIndParameter(loRowTbl.getIndParameter());
                    loParam.setLsIndValParameter(loRowTbl.getIndValParameter());
                    loColBean.add(loParam);
                }       
            } 
        } catch (Exception loEx) {
            System.out.println("Select by Id ERROR!!"+loEx.getMessage());
    ...
    public Integer validateExistByNomServicesCatModel(String psNomService) {      
        ...
        try {
            ...
            loObj.setWhereClause("IND_DESC_SERVICE = '" + psNomService+"'");
            loObj.setRangeSize(-1);
            loObj.executeQuery();            
            Row[] laRows = loObj.getAllRowsInRange();     
            if (laRows.length > 0) {
    ...
    public Integer searchIdCronConfigModel(Integer piIdService) {   
        ...
        try {
            ...
            if (laRows.length > 0) {
                for(int liI = 0; liI < laRows.length; liI++){
                    Row loRow = laRows[liI];
                    LmkIntCronConfigTabViewRowImpl loRowFound = (LmkIntCronConfigTabViewRowImpl)loRow;           
     ...
     * @return EvetvIntCronConfigTabRowBean
     */
    public LmkIntCronConfigRowBean getRowCronConfigByServiceModel(Integer piIdService) {   
        LmkIntCronConfigRowBean loRowResponse = new LmkIntCronConfigRowBean();     
       try {
            LmkIntCronConfigTabViewImpl    loObj = 
                getLmkIntCronConfigTabView1();
            loObj.setWhereClause("ID_SERVICE = " + piIdService);
           ...
           if (laRows.length > 0) {
               ...
               LmkIntCronConfigTabViewRowImpl loRowView = 
                   (LmkIntCronConfigTabViewRowImpl)loRow;     
               loRowResponse.setLiIdConfiguration(loRowView.getIdConfiguration());
               loRowResponse.setLiIdService(loRowView.getIdService());
               loRowResponse.setLsIndPeriodicity(loRowView.getIndPeriodicity());
               loRowResponse.setLsIndBeginSchedule(loRowView.getIndBeginSchedule());
               
               loRowResponse.setLsIndBeginMinute(loRowView.getIndBeginMinute());
               loRowResponse.setLsIndBeginSecond(loRowView.getIndBeginSecond());
               loRowResponse.setLsIndEndSchedule(loRowView.getIndEndSchedule());
               loRowResponse.setLsIndEndMinute(loRowView.getIndEndMinute());
               loRowResponse.setLsIndEndSecond(loRowView.getIndEndSecond());
               
               loRowResponse.setLsIndTypeSchedule(loRowView.getIndTypeSchedule());
               loRowResponse.setLsIndValTypeSchedule(loRowView.getIndValTypeSchedule());
               loRowResponse.setLiIndMonday(loRowView.getIndMonday());
               loRowResponse.setLiIndTuesday(loRowView.getIndTuesday());
               loRowResponse.setLiIndWednesday(loRowView.getIndWednesday());
               loRowResponse.setLiIndThursday(loRowView.getIndThursday());
               loRowResponse.setLiIndFriday(loRowView.getIndFriday());
               loRowResponse.setLiIndSaturday(loRowView.getIndSaturday());
               loRowResponse.setLiIndSunday(loRowView.getIndSunday());
               loRowResponse.setLiIndDayMonth(loRowView.getIndDayMonth());
               loRowResponse.setLiIndWeekMonth(loRowView.getIndWeekMonth());
               loRowResponse.setLsIndCronExpression(loRowView.getIndCronExpression());
    ...
    public void insertCronConfigModel(LmkIntCronConfigRowBean toLmkBean) {        
        ...
        try {
            ...
            System.out.println("getLsIndBeginMinute: "+toLmkBean.getLsIndBeginMinute());
            System.out.println("getLsIndBeginSecond: "+toLmkBean.getLsIndBeginSecond());
            System.out.println("getLsIndEndSchedule: "+toLmkBean.getLsIndEndSchedule());
            System.out.println("getLsIndEndMinute: "+toLmkBean.getLsIndEndMinute());
            System.out.println("getLsIndEndSecond: "+toLmkBean.getLsIndEndSecond());            
            System.out.println("getLsIndTypeSchedule: "+toLmkBean.getLsIndTypeSchedule());
            System.out.println("getLsIndValTypeSchedule: "+toLmkBean.getLsIndValTypeSchedule());
            System.out.println("getLiIndDayMonth: "+toLmkBean.getLiIndDayMonth());
            System.out.println("getLiIndWeekMonth: "+toLmkBean.getLiIndWeekMonth());
            System.out.println("getLsIndCronExpression: "+toLmkBean.getLsIndCronExpression());
            System.out.println("getLiIndMonday: "+toLmkBean.getLiIndMonday());
            System.out.println("getLiIndTuesday: "+toLmkBean.getLiIndTuesday());
            System.out.println("getLiIndWednesday: "+toLmkBean.getLiIndWednesday());
            System.out.println("getLiIndThursday: "+toLmkBean.getLiIndThursday());
    ...
    public String getCronExpressionModel(Integer piIdService) {      
        ...
        try {
            ...
            if (laRows.length > 0) {
                for(int liI = 0; liI < laRows.length; liI++){
                    Row loRow = laRows[liI];
                    LmkIntCronConfigTabViewRowImpl loRowCron = (LmkIntCronConfigTabViewRowImpl)loRow;           
                    try{       
    ...
    public void updateStatusCronConfigModel(Integer piIdService,
       ...
       try {
           ...
           if (laRows.length > 0) {
                Row loRow = loObj.getAllRowsInRange()[0];
               LmkIntCronConfigTabViewRowImpl loUpdRow = 
                   (LmkIntCronConfigTabViewRowImpl)loRow;                    
               loUpdRow.setIdService(piIdService);            
               loUpdRow.setIndEstatus(psStatusTab);
               loUpdRow.setFecLastUpdateDate(getCurrentTimestamp());
               String lsUserName = psUserName == null ? 
                   getValueSessionFromAttribute("loggedPgmIntegrationUser") : psUserName;
               String lsIdUser = psIdUser == null ? 
                   getValueSessionFromAttribute("loggedPgmIntegrationIdUser") : psIdUser;
    ...
    public String getParameterValue(String psNameParameter){
        String lsValue = "";
        LmkIntConfigParamTabViewImpl loObject = getLmkIntConfigParamTabView1();
        ...
        if (laObjs.length > 0) {
            Row loRow = laObjs[0];
            LmkIntConfigParamTabViewRowImpl loPgen =
                (LmkIntConfigParamTabViewRowImpl)loRow;
     ...
     */
    public LmkIntServiceBitacoraTabViewImpl getLmkIntServiceBitacoraTabView1() {
        return (LmkIntServiceBitacoraTabViewImpl) findViewObject("LmkIntServiceBitacoraTabView1");
    }
